...
pdf.cell(100, 10, txt="INVOICE #C2-003-QTY", ln=0, align='L')
pdf.cell(90, 10, txt="Date: 2024-05-25", ln=1, align='R')
pdf.ln(5)
...
# Line Items (Quantity Variance Scenario: Billing for 15 hours vs PO 10)
pdf.set_font("Arial", size=10)
pdf.cell(80, 10, txt="Tech Consulting - Level 1", border=1)
pdf.cell(30, 10, txt="15", border=1, align='C')  # Variance: 15 vs 10
pdf.cell(30, 10, txt="$50.00", border=1, align='R')
pdf.cell(30, 10, txt="$750.00", border=1, align='R')
pdf.ln()
...
pdf.cell(30, 10, txt="$750.00", align='R', ln=1)

pdf.cell(140, 10, txt="Tax (8.25%):", align='R')
pdf.cell(30, 10, txt="$61.88", align='R', ln=1)

pdf.set_font("Arial", 'B', 12)
pdf.cell(140, 10, txt="Total Due:", align='R')
pdf.cell(30, 10, txt="$811.88", align='R', ln=1)
...
pdf.output("C2-003_quantity_variance.pdf")
print("PDF Generated: C2-003_quantity_variance.pdf")
