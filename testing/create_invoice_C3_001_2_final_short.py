...
pdf.cell(100, 10, txt="INVOICE #C3-001-FINAL", ln=0, align='L')
pdf.cell(90, 10, txt="Date: 2024-06-15", ln=1, align='R')
pdf.ln(5)
...
# FINAL BILL INDICATOR (This is the key trigger for the test)
pdf.set_font("Arial", 'B', 14)
pdf.set_text_color(255, 0, 0) # Red Text
pdf.cell(0, 10, txt="*** FINAL BILL - PROJECT CLOSED ***", ln=1, align='C')
...
# Line Items (Short Delivery: Billing for 5 hours vs PO 10)
pdf.set_font("Arial", size=10)
pdf.cell(80, 10, txt="Tech Consulting - Level 1", border=1)
pdf.cell(30, 10, txt="5", border=1, align='C')  # Short: 5 vs 10 Ordered
...
pdf.output("testing/test_data/C3-001_2_final_short.pdf")
print("PDF Generated: testing/test_data/C3-001_2_final_short.pdf")
