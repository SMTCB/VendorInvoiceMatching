...
pdf.cell(100, 10, txt="INVOICE #C3-001-PARTIAL", ln=0, align='L')
pdf.cell(90, 10, txt="Date: 2024-05-30", ln=1, align='R')
pdf.ln(5)
...
# Line Items (Partial Delivery Scenario: Billing for 5 hours vs PO 10)
pdf.set_font("Arial", size=10)
pdf.cell(80, 10, txt="Tech Consulting - Level 1", border=1)
pdf.cell(30, 10, txt="5", border=1, align='C')  # Partial: 5 vs 10
pdf.cell(30, 10, txt="$50.00", border=1, align='R')
pdf.cell(30, 10, txt="$250.00", border=1, align='R')
pdf.ln()
...
pdf.cell(30, 10, txt="$250.00", align='R', ln=1)

pdf.cell(140, 10, txt="Tax (8.25%):", align='R')
pdf.cell(30, 10, txt="$20.63", align='R', ln=1)

pdf.set_font("Arial", 'B', 12)
pdf.cell(140, 10, txt="Total Due:", align='R')
pdf.cell(30, 10, txt="$270.63", align='R', ln=1)

# Footer
pdf.ln(20)
pdf.set_font("Arial", 'I', 8)
pdf.cell(0, 10, txt="Partial delivery invoice. Remaining balance to be billed upon completion.", align='C')

pdf.output("testing/test_data/C3-001_1_partial_delivery.pdf")
print("PDF Generated: testing/test_data/C3-001_1_partial_delivery.pdf")
